                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="d-flex flex-stack flex-wrap ms-10 mt-10">
                        ...
                        <div class="page-title d-flex flex-column align-items-start">
                            <!--begin::Title-->
                            <h1 class="d-flex text-dark fw-bold m-0 fs-3">Data Agenda</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                        ...
                        <!--end::Page title-->
                        <!--begin::Add pengurus-->
                            <button type="button" class="btn btn-sm btn-light" onclick="tambah_agenda()" data-bs-toggle="modal" data-bs-target="#kt_modal_agenda">
                                <i class="ki-duotone ki-plus fs-2"></i>Tambah Agenda</button>
                            <!--end::Add pengurus-->
                    </div>
                    <!--begin::Body-->
                    <div class="card-body py-3" id="base_table">
                        <!--begin::Table container-->
                        <form action="<?= base_url('management_function/drag_agenda') ?>" method="POST" class="table-responsive" id="reload_table">
                            <!--begin::Table-->
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                <!--begin::Table head-->
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        <th class="min-w-150px">Agenda</th>
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="symbol symbol-100px me-5">
                                                            <?php if($row->gambar) : ?>
                                                            <img src="<?= image_check($row->gambar, 'agenda') ?>" alt="">
                                                            <?php else : ?>
                                                                -
                                                            <?php endif;?>
                                                        </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Ubah data agenda" onclick="edit_agenda(this,<?= $row->id_agenda; ?>)" data-image="<?= image_check($row->gambar, 'agenda') ?>" data-bs-toggle="modal" data-bs-target="#kt_modal_agenda">
                                                            <i class="ki-outline ki-pencil fs-2"></i>
                                                        </button>
                                                        <button type="button" onclick="hapus_data(event,<?= $row->id_agenda; ?>,'management_function/hapus_agenda','agenda')" title="Hapus data agenda" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="4">
                                                <center>Data agenda tidak ditemukan</center>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
...
<!-- Modal Tambah agenda -->
<div class="modal fade" id="kt_modal_agenda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="title_modal">Tambah Agenda</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_agenda" class="form" action="<?= base_url('management_function/tambah_agenda') ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="#" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_agenda_header" data-kt-scroll-wrappers="#kt_modal_agenda_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="fv-row mb-7 d-flex justify-content-center align-items-center flex-column">
                            <!--begin::Label-->
                            <label class="required d-block fw-semibold fs-6 mb-5">Gambar Agenda</label>
                            <!--end::Label-->
                            <!--begin::Image input-->
                        ...
                        <div class="fv-row mb-7" id="req_title">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Judul Agenda</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Masukkan judul agenda" autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        <button type="button" id="submit_agenda" onclick="submit_form(this,'#form_agenda',1)" class="btn btn-primary">
