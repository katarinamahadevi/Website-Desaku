            ...
            <div class="row g-5 g-xl-10">
                <div class="card mb-5 mb-xl-8">
                    <div class="d-flex flex-stack flex-wrap ms-10 mt-10">
                        ...
                        <!--end::Page title-->
                        <!--begin::Add pengurus-->
                            <button type="button" class="btn btn-sm btn-light" onclick="tambah_banner()" data-bs-toggle="modal" data-bs-target="#kt_modal_banner">
                    ...
                    <div class="card-body py-3" id="base_table">
                        ...
                        <form action="<?= base_url('management_function/drag_banner') ?>" method="POST" class="table-responsive" id="reload_table">
                            <!--begin::Table-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Ubah data banner" onclick="edit_banner(this,<?= $row->id_banner; ?>)" data-image="<?= image_check($row->gambar, 'banner') ?>" data-bs-toggle="modal" data-bs-target="#kt_modal_banner">
                                                            <i class="ki-outline ki-pencil fs-2"></i>
                                                        </button>
                                                        <button type="button" onclick="hapus_data(event,<?= $row->id_banner; ?>,'management_function/hapus_banner','banner')" title="Hapus data banner" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="title_modal">Tambah Banner</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="form_banner" class="form" action="<?= base_url('management_function/tambah_banner') ?>" method="POST" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="#" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_banner_header" data-kt-scroll-wrappers="#kt_modal_banner_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        <div class="fv-row mb-7 d-flex justify-content-center align-items-center flex-column">
                            <!--begin::Label-->
                            <label class="required d-block fw-semibold fs-6 mb-5">Gambar Banner</label>
                            <!--end::Label-->
                            <!--begin::Image input-->
                        ...
                        <div class="fv-row mb-7" id="req_title">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Judul Banner</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Masukkan judul banner" autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
