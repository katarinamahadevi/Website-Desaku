                    ...
                    <div class="d-flex justify-content-center flex-wrap ms-10 mt-10 mb-8">
                        ...
                        <div class="page-title d-flex flex-column align-items-center justify-content-center">
                            ...
                            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-gray-600">Isi Ulang</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                    ...
                    <div class="card-header border-0 pt-5">
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                ?>
                                <a id="cetak_excel" target="_blank" href="<?= base_url('cetak/excel/topup').$params ?>" onclick="confirm_alert(this,event,'Anda akan mencetak data dengan format excel sesuai dengan data filter')" class="btn btn-sm btn-primary me-3">
                            ...
                            <table class="table table-bordered table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        <th class="min-w-450px"><center>Tanggal</center></th>
                                        <th class="min-w-200px"><center>Customer</center></th>
                                        <th class="min-w-80px"><center>Nominal Top Up</center></th>
                                        <th class="min-w-100px text-center">Bukti</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                                <tbody>
                                    <?php if($result) : ?>
                                        <?php $no = 1; foreach($result AS $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-muted fw-semibold"><?= $row->nominal; ?></td>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="8"><center>Tidak ada data isi ulang bulan ini</center></td>
                                        </tr>
                                    <?php endif;?>
                                </tbody>
                                <!--end::Table body-->
