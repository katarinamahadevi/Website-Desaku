                            ...
                            <table class="table table-bordered table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        ...
                                        <th class="min-w-100px"><center>Doc</center></th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                                <tbody>
                                    <?php if($result) : ?>
                                        <?php $no = 1; foreach($result AS $row) : ?>
                                            <tr>
                                                <td class="text-muted fw-semibold"><center><?= date('d F Y',strtotime($row->tanggal)); ?></br><?= date('H:i',strtotime($row->tanggal)) ?></center></td>
                                                <td class="text-muted fw-semibold"><center> <span class="badge badge-<?= wd_color($row->status); ?>"><?= status_wd($row->status); ?></span></center></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif(in_array($row->status,[2])) : ?>
                                                    ...
                                                    <?php else : ?>
                                                         <button class="btn btn-icon btn-secondary btn-sm me-1">
                                                                -
                                                        </button>
                                                    <?php endif;?>
                                                    </div>
