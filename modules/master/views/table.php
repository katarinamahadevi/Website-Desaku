                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <div class="d-flex align-items-center position-relative me-3 search_mekanik w-300px">
                            ...
                            <button type="button" onclick="search()" class="btn btn-primary d-none" type="button" id="button-cari-user">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px filter_mekanik" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" onclick="filter(['role','status'])" class="btn btn-primary fw-semibold px-6">Terapkan</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Content-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-45px me-5">
                                                            <img class="cursor-pointer" onclick="preview_image(this)" src="<?= image_check($row->foto, 'user') ?>" alt="">
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            ...
                                                            <span class="text-muted fw-semibold text-muted d-block fs-7"><?= price_format($row->saldo,1) ?></span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <?php
                                                        if ($row->blocked == 'Y') {
                                                            $alert = 'Anda yakin akan membuka block pada user ' . $row->nama . '? User akan kembali dapat mengakses sistem';
                                                            $val = 'N';
                                                        } else {
                                                            $alert = 'Anda yakin akan melakukan block pada user ' . $row->nama . '? User tidak akan bisa melakukan akses pada sistem';
                                                            $val = 'Y';
                                                        }
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1" title="Ubah data user" onclick="edit_user(this,<?= $row->id_user; ?>)" data-image="<?= image_check($row->foto, 'user') ?>" data-bs-toggle="modal" data-bs-target="#kt_modal_user">
