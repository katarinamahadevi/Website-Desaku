            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-12 text-center text-md-center mb-md-0">
                        <span class="text-body"><a href="<?= base_url('beranda'); ?>"><i class="fas fa-copyright text-light me-2"></i>Desaku</a></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Javascript Charts -->
        <script src="<?= base_url('assets/user/') ?>js/chart1.js"></script>
